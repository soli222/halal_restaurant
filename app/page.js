  ...
  if (ownerStep !== null && ownerStep !== 'subscription') {
    return (
      <OwnerOnboarding
        ...
        cuisineOther={onboarding.cuisineOther}
        setCuisineOther={onboarding.setCuisineOther}
        certifyingBody={onboarding.certifyingBody}
        setCertifyingBody={onboarding.setCertifyingBody}
        certOtherDetails={onboarding.certOtherDetails}
        setCertOtherDetails={onboarding.setCertOtherDetails}
        certNumber={onboarding.certNumber}
        setCertNumber={onboarding.setCertNumber}
        certNumberNA={onboarding.certNumberNA}
        setCertNumberNA={onboarding.setCertNumberNA}
        certNumberNADetails={onboarding.certNumberNADetails}
