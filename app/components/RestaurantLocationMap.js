  ...
  return (
    <div className="bg-[#111111] border border-white/5 rounded-2xl overflow-hidden">
      ...
      {hasCoords ? (
        ...
        <div className="h-36 flex flex-col items-center justify-center gap-3 bg-white/[0.02] border-t border-white/5 px-6 text-center">
          <svg className="w-8 h-8 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
          </svg>
          <div>
            <p className="text-sm text-gray-500 font-medium">Map not available</p>
            <p className="text-xs text-gray-600 mt-0.5">Use the Get Directions button to find this restaurant.</p>
          </div>
        </div>
      )}
